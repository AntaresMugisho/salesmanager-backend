    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('OWNER', 'Propriétaire'), ('MANAGER', 'Gérant'), ('CASHIER', 'Caissier')], default='CASHIER', max_length=16, verbose_name='rôle')),
                ('avatar_url', models.URLField(blank=True, max_length=500, null=True, verbose_name='avatar')),
